    ...
    <div className="flex flex-col h-full overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="flex flex-1 overflow-hidden p-6 gap-6">
        ...
        <section className="flex-1 flex flex-col gap-4 overflow-hidden">
          <Card variant="glass" className="flex-1 overflow-hidden flex flex-col border-zinc-800/40">
            <div className="px-6 py-4 border-b border-zinc-900 bg-white/[0.02] flex items-center justify-between">
        ...
        <aside className="w-96 shrink-0 flex flex-col gap-4 overflow-hidden">
          <Card variant="glass" className="flex-1 flex flex-col border-indigo-500/20 bg-indigo-500/[0.02]">
            <div className="px-6 py-4 border-b border-indigo-500/10 bg-indigo-500/5 flex items-center justify-between">
              <h2 className="text-xs font-bold text-indigo-400 uppercase tracking-widest flex items-center gap-2">
                <Sparkles className="w-3.5 h-3.5" />
                AI Analysis
              </h2>
              <Badge className="bg-indigo-500 text-white border-none text-[9px] px-1.5 py-0">LIVE</Badge>
            </div>
            <div className="flex-1 overflow-auto p-4">
              <PluginGroupRenderer group={SuggestionsPluginGroup} />
            </div>
            <div className="p-4 border-t border-indigo-500/10 bg-indigo-500/5">
              <p className="text-[10px] text-indigo-400/60 font-medium italic text-center">
